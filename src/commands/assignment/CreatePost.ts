	...
	public async action(message: Message, args: string[]): Promise<any> {
		...
		switch (args[0]) {
			case 'platform': {
					...
					embed.setDescription(`React with each of the platforms you are playing Destiny on, by clicking on the corresponding platform icon below.`);
                    embed.setImage('http://compass.xbox.com/assets/96/6b/966baf34-e121-4173-a3d7-b7ff5475f880.jpg?n=D2_GLP-Page-Hero-1084_1920x600.jpg');
