...
Constants.channelNames = [ 'Sweeper Bot', 'Wei Ning', 'Mara Sov', 'Saint-14', 'Rasputin', 'Uldren Sov', 'Osiris', 'Eriana-3', 'Toland', 'Ana Bray', 'Dredgen Yor', 'Pahanin', 'Tevis', 'Xur', 'Cayde-6', 'Zavala', 'Ikora Rey', 'Kabr', 'Ghaul', 'Praedyth', 'Uldren', 'Vosik', 'Phogoth', 'Petra', 'Crota', 'Piece of Celery', 'Toland The Shattered', 'Ascendant Raisins', 'Red Legion', 'Jolder', 'Rahool', 'Eris Morn', 'Ghost', 'Lord Shaxx', 'Kadi 55-30', 'Lord Shaladin', 'Skolas', 'The Speaker', 'Variks', 'Xander 99-40', 'The Darkness ', 'Exo Stranger ', 'toland', 'Wei Ning ', 'Charlemagne', 'Hawthorne', 'Cozmo-23', 'DeeJ', 'Ahamkara', 'Jaren Ward', 'Radegast', 'Timur', 'Gheleon', 'Efrideet', 'Brother Vance', 'Alak-Hul', 'Eris', 'Amanda Holliday', 'Dinklebot', 'Ralph the Chicken', 'The Traveler'];
